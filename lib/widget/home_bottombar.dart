      ...
      items: <Widget>[
        ...
        Column(
          children: const <Widget>[
            ...
            // if (page != 1) const Text("Score Board"),
          ],
        ),
        Column(
          children: const <Widget>[
...
class CurvedNavigationBar extends StatefulWidget {
  ...
  CurvedNavigationBar({
    ...
    required this.items,
    this.index = 0,
    this.color = const Color(0xffcbcbe5),
...
//           Positioned(
//             top: -40,
//             left: screen.width / 4 - screen.width / 8 - 20,
//             width: 80,
//             height: 80,
//             child: Container(
...
//                   Radius.circular(screen.width / 8 - 10),
//                 ),
//               ),
//               child: const Icon(
//                 Icons.home_outlined,
