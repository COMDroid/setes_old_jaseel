...
class OtpPage extends StatefulWidget {
  final Map data;
  const OtpPage(this.data, {Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    TextField(
                      controller: state["otpC"],
                      autocorrect: true,
                      keyboardType: TextInputType.number,
                      decoration:
                          textBoxStyle1('4 Digit code', Icons.pin_outlined),
                    ),
          ...
          Positioned(
            top: screen.height * .35 + 170,
            left: screen.width * .5 - 30,
            width: 60,
            height: 60,
            child: InkWell(
              onTap: () => validateOtp(context, setstate, state, widget.data),
              child: Container(
                decoration: BoxDecoration(
